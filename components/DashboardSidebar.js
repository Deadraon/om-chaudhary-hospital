...
export default function DashboardSidebar({ user = { name: 'User', role: 'patient' } }) {
  ...
  const navItems = {
    super_admin: [
      ...
      { name: 'Beds & OT Inventory', href: '/dashboard/admin/inventory', icon: '🏨' },
    ],
    doctor: [
      { name: 'My Schedule', href: '/dashboard/doctor', icon: '📅' },
      { name: 'Appointments', href: '/dashboard/doctor/appointments', icon: '🗒️' },
      { name: 'Assigned Patients', href: '/dashboard/doctor/patients', icon: '🩹' },
    ],
    receptionist: [
      ...
      { name: 'Patients', href: '/dashboard/receptionist/patients', icon: '🩹' },
    ],
    patient: [
