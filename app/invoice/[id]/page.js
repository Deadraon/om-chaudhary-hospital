  ...
  if (!invoice) {
    return (
      <div style={{ padding: '60px', textAlign: 'center', fontFamily: 'Arial, sans-serif', color: '#666' }}>
        ...
        <p style={{ marginTop: '8px' }}>Please verify the URL or return to the billing section.</p>
        <a href="/dashboard/admin/billing" style={{ display: 'inline-block', marginTop: '16px', color: '#0f465c', fontWeight: 700 }}>
          ← Back to Billing
        </a>
      </div>
    );
  ...
  return (
    <>
      ...
      <div className="no-print" style={{
        ...
        <a href="/dashboard/admin/billing" style={{
      ...
      <div style={{ minHeight: '100vh', padding: '32px 16px', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', background: '#f0f4f8' }}>
        <div className="invoice-page" style={{
          ...
          borderRadius: '12px', boxShadow: '0 6px 40px rgba(0,0,0,0.13)',
          overflow: 'hidden',
        }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '10px', color: '#67e8f9', fontWeight: 700, letterSpacing: '2.5px', textTransform: 'uppercase', marginTop: '2px' }}>
              ...
              <div style={{ textAlign: 'right', flexShrink: 0 }}>
                <div style={{ fontSize: '9px', color: '#67e8f9', fontWeight: 700, letterSpacing: '3px', textTransform: 'uppercase', marginBottom: '4px' }}>
                  TAX INVOICE
                </div>
            ...
            <div style={{ background: '#f8fafc', padding: '22px 32px' }}>
              ...
              {invoice.patient_age && (
                <div style={{ fontSize: '12px', color: '#475569', marginTop: '4px' }}>
                  Age: {invoice.patient_age} yrs &nbsp;|&nbsp; {invoice.patient_gender || '—'}
                </div>
              )}
              <div style={{ fontSize: '12px', color: '#475569', marginTop: '4px' }}>
            ...
            <tbody>
              {items.map((item, idx) => (
                <tr key={idx} style={{ background: idx % 2 === 0 ? '#fff' : '#f8fafc', borderBottom: '1px solid #e5e7eb' }}>
                  <td style={{ padding: '14px 20px', textAlign: 'center', fontSize: '12px', color: '#94a3b8', fontWeight: 700 }}>
                  ...
                  <td style={{ padding: '14px 20px', textAlign: 'right', fontSize: '13px', color: '#334155' }}>
                    ₹{(item.price || 0).toLocaleString('en-IN')}
                  </td>
                  <td style={{ padding: '14px 20px', textAlign: 'right', fontSize: '13px', color: '#334155' }}>
                    {item.qty || 1}
                  </td>
                  <td style={{ padding: '14px 32px 14px 20px', textAlign: 'right', fontSize: '13px', color: '#0f172a', fontWeight: 700 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', borderTop: '2px solid #e5e7eb' }}>
            ...
            <div style={{ padding: '24px 32px', borderRight: '1px solid #e5e7eb' }}>
              <div style={{ fontSize: '9px', fontWeight: 800, color: '#64748b', textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: '8px' }}>
                Terms & Notes
              </div>
              <p style={{ fontSize: '11px', color: '#475569', lineHeight: 1.75 }}>
                This is a computer-generated invoice and is valid without a physical signature.
                Kindly preserve this receipt for TPA/insurance or tax purposes.
                For billing disputes contact the accounts office within 7 days of issue date.
              </p>
            ...
            <div style={{ padding: '24px 32px', background: '#f8fafc' }}>
              <div style={{ fontSize: '9px', fontWeight: 800, color: '#64748b', textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: '12px' }}>
                Summary
              </div>
              <table style={{ width: '100%', fontSize: '12px', borderCollapse: 'collapse' }}>
                <tbody>
                  <tr>
                    ...
                    <td style={{ padding: '5px 0', textAlign: 'right', fontWeight: 600 }}>₹{subtotal.toLocaleString('en-IN')}</td>
                  </tr>
                  {invoice.tax > 0 && (
                    <tr>
                      <td style={{ padding: '5px 0', color: '#64748b' }}>Tax ({invoice.tax}%)</td>
                      <td style={{ padding: '5px 0', textAlign: 'right', fontWeight: 600 }}>₹{taxAmount.toLocaleString('en-IN')}</td>
                    </tr>
                  )}
                  {discount > 0 && (
                    <tr>
                      <td style={{ padding: '5px 0', color: '#64748b' }}>Discount</td>
                      <td style={{ padding: '5px 0', textAlign: 'right', fontWeight: 600, color: '#dc2626' }}>− ₹{discount.toLocaleString('en-IN')}</td>
                    </tr>
                  )}
                  ...
                  <tr>
                    ...
                    <td style={{ padding: '4px 0', textAlign: 'right', fontWeight: 900, fontSize: '18px', color: '#0f465c' }}>
                      ₹{total.toLocaleString('en-IN')}
                    </td>
                  </tr>
                  <tr>
                    <td colSpan={2} style={{ paddingTop: '4px', fontSize: '9px', color: '#94a3b8', textAlign: 'right' }}>
                      INR (Indian Rupees)
                    </td>
                  </tr>
                </tbody>
          ...
          <div style={{ background: '#f1f5f9', borderTop: '1px solid #e2e8f0', padding: '20px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div style={{ fontSize: '10px', color: '#94a3b8' }}>
              <div style={{ fontWeight: 700, color: '#475569', marginBottom: '3px', textTransform: 'uppercase', letterSpacing: '1px', fontSize: '9px' }}>
                Hospital Address
              </div>
              {HOSPITAL_ADDRESS}
            </div>
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ fontSize: '9px', color: '#64748b', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1.5px' }}>
